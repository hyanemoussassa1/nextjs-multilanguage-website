const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-gray-300 container mx-auto">
    
      <div className="flex flex-row space-x-16">
        <div className="items-center my-8 space-y-4">
          <a className="flex flex-column" href="https://www.storyblok.com/tp/next-js-react-guide">
            About us
          </a>
          <a className="flex flex-column" href="https://www.storyblok.com/tp/next-js-react-guide">
            Contact us
      ...
      <p className="underline">
        <a href="https://www.storyblok.com/tp/next-js-react-guide">
          Next.js Website created with Storyblok
        </a>
      </p>
    </footer>
  );
